...
serverList='
  10.10.108.157,work,/home/work/fe/office-website-react
'
# ==================你需要修改的=================
...
function doDeploy {
  ...
  tar -C ./dist -czf - ./ | ssh -o StrictHostKeyChecking=no work@${ip} "tar -C ${dir} -xzf -"
  ssh -o StrictHostKeyChecking=no work@${ip} "cd ${dir}"
}
